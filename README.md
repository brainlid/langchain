...
<img src="https://github.com/brainlid/langchain/blob/main/langchain_functions_overview.png" width=50% height=50% alt="Diagram showing LLM integration to application logic and data through "Functions".">
