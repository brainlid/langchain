...
Application.put_env(:langchain, :openai_key, "abc123")
Application.put_env(:langchain, :anthropic_key, "abc123")
Application.put_env(:langchain, :google_ai_key, "abc123")
Application.put_env(:langchain, :aws_access_key_id, "abc123")
